...
export const vayikra16e: TaskContent = {
  ...
  readingIntro:
    "הפרק כולו, 34 פסוקים. הכפתור ״🔊 האזנה לקטע״ משמיע אותו מתחילתו ועד סופו. עקבו בתנ״ך הפיזי.",
  partB: {
    title: "מפת הפרק",
      ...
      blocks: [
        {
          type: "intro",
          key: "intro-structure",
          body: "למדנו את הפרק בארבעה שיעורים, אבל הפרק עצמו מתחלק לחמישה חלקים לפי הפעולות. פתחו את פרק ט״ז בתנ״ך הפיזי, וחפשו את המילים שבהן כל חלק מתחיל.",
        },
        {
          type: "question",
          key: "q-parts",
          ...
          prompt:
            "לכל אחד מחמשת החלקים כתבו מאיזה פסוק עד איזה פסוק הוא נמשך:",
          fields: [
        ...
        },
        {
          ...
          prompt:
            "אהרן מחליף בגדים כמה פעמים בפרק. מצאו את כל הפסוקים שבהם אהרן לובש בגדים או פושט בגדים. לכל פסוק כתבו: מספר הפסוק, ומה הוא לובש או פושט.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          prompt:
            "פתחו את פרק ט״ז בתנ״ך הפיזי (המסך סגור!). באיזה פסוק מופיע כל אחד מהביטויים הבאים? כתבו את מספר הפסוק.",
          fields: [
        ...
        },
        {
          ...
          prompt:
            "פתחו את התנ״ך שבידכם. (1) באיזה עמוד מתחיל ספר ויקרא? (2) באיזה עמוד מתחיל פרק ט״ז?",
          fields: [
            { key: "book", label: "(1) עמוד תחילת ספר ויקרא" },
            { key: "chapter", label: "(2) עמוד תחילת פרק ט״ז" },
          ],
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          label: "קריאה והבנה",
          prompt:
            "קראו את פסוקים ט׳–י׳, ט״ו, כ׳–כ״ב. סכמו בשני משפטים: (1) מה עושים בשעיר שעלה עליו הגורל לה׳? (2) מה עושים בשעיר שעלה עליו הגורל לעזאזל?",
          fields: [
            { key: "lord", label: "(1) השעיר לה׳" },
            { key: "azazel", label: "(2) השעיר לעזאזל" },
          ],
          helpVerses: {
        ...
        },
        {
          ...
          label: "קריאה והבנה",
          prompt:
            "קראו את פסוק ב׳ ואת פסוק י״ג. הביטוי ״וְלֹא יָמוּת״ מופיע בשניהם. (1) בפסוק ב׳: מה צריך לעשות, או לא לעשות, כדי לא למות? (2) בפסוק י״ג: מה צריך לעשות כדי לא למות?",
          fields: [
            { key: "v2", label: "(1) פסוק ב׳" },
            { key: "v13", label: "(2) פסוק י״ג" },
          ],
      ...
      blocks: [
        {
          ...
          label: "טעמי המקרא",
          prompt:
            "בחרו שלושה פסוקים מהפרק: אחד מפסוקים א׳–י׳, אחד מפסוקים י״א–כ״ב, ואחד מפסוקים כ״ג–ל״ד. לכל פסוק כתבו את מספרו ואת המילה שבה מסומנת האתנחתא. (בפרק יש פסוק קצר אחד בלי אתנחתא בכלל — מי מוצא אותו?)",
          fields: [
      ...
      blocks: [
        {
          ...
          prompt:
            "האזינו לפרק כולו: לחצו על הכפתור ״🔊 האזנה לקטע״ בבלוק הפסוקים שבראש המשימה, ועקבו בתנ״ך הפיזי. (1) באיזה פסוק ״איבדתם״ את הקריין לרגע? אם לא איבדתם — כתבו: לא איבדתי. (2) מה עזר לכם לחזור אליו?",
          fields: [
            { key: "lost", label: "(1) איפה איבדתי / לא איבדתי" },
            { key: "back", label: "(2) מה עזר לחזור" },
          ],
        },
        {
          type: "question",
          ...
          label: "במילים שלי",
          prompt:
            "דמיינו שתלמיד או תלמידה מכיתה ח׳ שואלים אתכם: ״מה קורה במשכן ביום הזה?״ הסבירו להם בשלושה משפטים — רק מה שכתוב בפרק, בלי פרשנים.",
          minWords: 20,
        },
      ],
    },
