...
export const vayikra16e: TaskContent = {
  ...
  subtitle: "עבודת הכהן הגדול ביום הכיפורים · חלק 5 מתוך 5 · סיכום",
  bookRef: "ספר ויקרא, פרק ט״ז (הפרק כולו)",
  skill: "התמצאות בתנ״ך · הבנת המבנה · טעמי המקרא · האזנה לפרק שלם",
  readingIntro:
    "הפעם הפרק כולו לפניכם — 34 פסוקים. לחצו 🔊 ״האזנה לקטע״ והקשיבו לפרק מתחילתו ועד סופו תוך כדי מעקב בתנ״ך הפיזי (לא במסך). כשהקריין עובר לפסוק חדש — הזיזו את האצבע. אם ״איבדתם״ אותו לרגע, סוף הפסוק ׃ ומספרי הפסוקים יעזרו לכם לחזור.",
  heroArt: {
    art: "chapter-map",
    caption:
      "מהפרוכת אל המדבר ובחזרה: פרק ט״ז הוא סדר של פעולות, במקום ובזמן. היום נבנה לו מפה.",
  },
  partA: { title: "האזנה לפרק כולו", skill: "מעקב, האזנה והתמצאות בפרק שלם" },
  partB: {
    title: "מפת הפרק",
