...
export const vayikra16a: TaskContent = {
  ...
  subtitle: "עבודת הכהן הגדול ביום הכיפורים · חלק 1 מתוך 5",
  bookRef: "ספר ויקרא, פרק ט״ז (פסוקים א׳–י׳)",
  skill: "הבנת הנקרא · התמצאות בתנ״ך · טעמי המקרא (אתנחתא וסוף פסוק) · קריאה והאזנה",
  readingIntro:
    "קראו את הפסוקים בנחת, ואז לחצו 🔊 ״האזנה לקטע״ והקשיבו לקריין תוך כדי מעקב עם העיניים. שימו לב איפה הוא עוצר: עצירה קטנה באמצע הפסוק (אתנחתא ֑) ועצירה ארוכה בסופו (סוף פסוק ׃). עוד לא עונים על כלום — רק פוגשים את הטקסט.",
  heroArt: {
    art: "veil-threshold",
    caption:
      ...
      blocks: [
        {
          type: "intro",
          key: "intro-taamim",
          body: "שני טעמים חשובים לנו השנה: האֶתְנַחְתָּא ( ֑ , סימן קטן מתחת למילה) היא ה״פסיק״ של הפסוק — היא מחלקת אותו לשני חלקים. סוֹף פָּסוּק ( ׃ ) הוא ה״נקודה״. בקטע למעלה אפשר ללחוץ על ״🎯 אתנחתא״ כדי להדגיש את המילים שבהן היא מסומנת.",
        },
        {
          type: "question",
          key: "q-etnachta-3",
