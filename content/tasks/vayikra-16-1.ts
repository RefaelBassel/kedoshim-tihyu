      ...
      blocks: [
        {
          ...
          label: "התמצאות בתנ״ך",
          prompt:
            "פתחו תנ״ך. ספר ויקרא הוא הספר השלישי בחמשת חומשי התורה. (1) איזה ספר נמצא לפני ספר ויקרא? (2) איזה ספר נמצא אחרי ספר ויקרא?",
          fields: [
            { key: "before", label: "(1) הספר שלפני ויקרא" },
            { key: "after", label: "(2) הספר שאחרי ויקרא" },
          ],
        },
        {
          type: "question",
          ...
          prompt:
            "קראו את פסוק א׳. הפסוק פותח במילים ״אַחֲרֵי מוֹת שְׁנֵי בְּנֵי אַהֲרֹן״. באיזה פרק בספר ויקרא מסופר על מותם של שני בני אהרן? דפדפו אחורה בספר וחפשו את השמות נָדָב וַאֲבִיהוּא. (1) כתבו את מספר הפרק. (2) כתבו את מספר הפסוק שבו הם מתים.",
          fields: [
            { key: "chapter", label: "(1) מספר הפרק" },
            { key: "verse", label: "(2) מספר הפסוק" },
          ],
