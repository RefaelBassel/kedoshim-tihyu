...
export const vayikra16c: TaskContent = {
  ...
  subtitle: "עבודת הכהן הגדול ביום הכיפורים · חלק 3 מתוך 5",
  bookRef: "ספר ויקרא, פרק ט״ז (פסוקים כ׳–כ״ח)",
  skill: "הבנת הנקרא · התמצאות בתנ״ך · טעמי המקרא (אתנחתא וסוף פסוק) · קריאה והאזנה",
  readingIntro:
    "עכשיו יוצאים החוצה: מהקודש אל השעיר החי, ומהמחנה אל המדבר. קראו את הפסוקים, ואז האזינו 🔊. פסוק כ״א ארוך במיוחד — הקשיבו איפה הקריין נושם ועוצר, ובדקו אם זה במקום שבו מסומנת האתנחתא.",
  heroArt: {
    art: "wilderness-goat",
    caption:
